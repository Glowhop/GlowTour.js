...
- The classes are always added, never replaced: a step's classes come after the workflow ones for the same component, and both come after the classes given to the component itself.
